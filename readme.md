...
**secrdesignapp** is a partial interactive interface to the R package [secrdesign](https://CRAN.R-project.org/package=secrdesign) (Efford 2025a). See the Help tab for details.
...
Click this link to run secrdesignapp 1.5 in your web browser from a University of Otago server (2.0 will follow soon):
