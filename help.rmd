...
The latest addition to secrdesignapp is optimization of detector layouts using a genetic algorithm as implemented in the R package **kofnGA** (Wolters 2015). The criterion may be either min(E(n),E(r)) (Durbach et al. (2021) or the number detected at two or more detectors (Dupont et al. 2021). The min(n,r) criterion is the default, and is usually preferred.
