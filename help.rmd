...
The 'Lacework' option (**secr** $\ge$ 4.1.1) places detectors along the lines of a square grid. It is best for the spacing along the lines to be a submultiple of the spacing of the systematic grid. Lacework assumes single detectors.
