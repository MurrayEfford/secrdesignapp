...
One simulated realisation of a uniformly distributed population. The 'Restrict to mask' option is available only when 2-D distribution is Poisson.
...
NOTE: If the 2-D distribution is not Poisson then the 'Simulated RSE' will be misleading because it is the average of the biased estimates of RSE reported when the model is fitted assuming a Poisson distribution. For non-Poisson 2-D distribution, rely on the 'Empirical RSE', noting that this requires many replicates and maximization of the likelihood.
