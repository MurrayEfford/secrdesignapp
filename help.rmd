...
The mask may either be built by buffering around the detector array (see Design) or imported from a text file. The default buffer multiplier (4) may be inadequate when detectfn = 'HEX'. The format of the text file is that exported from **secr** >3.2.1with `write.mask`
