...
The 'Suggest spacing' button finds the spacing with E(n) = E(r) and sets this for the current grid.
                
### Line

For a line the options are simply the number of detectors and the spacing. Lines are implemented with `make.grid` as for grids. The 'Suggest spacing' button finds the spacing with E(n) = E(r) and sets this for the current line.
